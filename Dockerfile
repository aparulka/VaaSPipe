...
#    && which python3.6 && python3.6 -V \
#    && which pip     && pip -V \
#    && which pip2    && pip2 -V \
#    && which pip3.6    && pip3.6 -V

RUN python2 -m pip install --upgrade pip && python3 -m pip install --upgrade pip \
	&& python -m pip install PyYAML requests python-dateutil pytz psycopg2 & python3 -m pip install PyYAML requests python-dateutil pytz psycopg2
